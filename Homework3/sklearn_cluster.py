...
# print(kmeans(matrix, text_label))
# print(affinity_propagation(matrix, text_label))
# print(mean_shift(matrix, text_label))
# print(spectral_clustering(matrix, text_label))
# print(agglomerative_clustering(matrix, text_label, 'ward'))
# print(agglomerative_clustering(matrix, text_label, 'complete'))
# print(agglomerative_clustering(matrix, text_label, 'average'))
# print(dbscan(matrix, text_label))
# print(gaussian_mixture(matrix, text_label))
# print(birch(matrix, text_label))